...
import {
  ...
  createCategory,
  fetchCategories,
} from "../../../services/operations/auctionAPI";
...
const CreateAuction = () => {
  ...
  const handleDateChange = (e) => {
    ...
    const formattedDateTime = new Date(
      `${date}T${now.getHours().toString().padStart(2, "0")}:${now
        .getMinutes()
        .toString()
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600">
            Fill out the details below to create your auction
          </p>
        </motion.div>
                ...
                >
                  ...
                  <Input
                    ...
                    {...register("startingPrice", {
                      ...
                      min: {
                        value: 100,
                        message: "Starting price must be at least INR 1000",
                      },
                    })}
                  />
                  {errors.startingPrice && (

    ...
    <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
      <div className="bg-white mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-md">
        ...
        <form className="flex flex-col gap-5 w-full" onSubmit={handleRegister}>
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <div className="flex flex-col sm:flex-1">
              ...
              <input
                ...
                className="text-[16px] py-2 bg-transparent border-[1px] border-stone-500 rounded-md focus:outline-none transition-all duration-300"
              />
            </div>
            <div className="flex flex-col sm:flex-1">
          ...
          {/* Conditional fields for Auctioneer */}
          {role === "Auctioneer" && (
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                  <select
                    ...
                    className="text-[16px] py-2 bg-transparent border-[1px] border-stone-500 rounded-md focus:outline-none sm:flex-1 transition-all duration-300"
                  >
